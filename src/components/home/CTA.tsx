      ...
      <div className={`${styles.borderColor} flex flex-col md:mx-11 mx-5 border-x py-[75px] space-y-20`}>
        ...
        <div className="flex flex-row w-full justify-between">
          <div className="flex md:flex-row flex-col md:px-12 px-6 items-start w-full md:space-x-6 space-y-6 md:space-y-0">
            <Button href="https://docs.google.com/forms/d/1K4TKHANO3iWyFM51OqRXBqT1wP2FTYEjE1pdz6559Y0/viewform?edit_requested=true" variant="secondary" className="flex-col items-center md:w-[272px] w-[285px] py-14 space-y-1.5">
