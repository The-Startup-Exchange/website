...
const BuildersInSX = () => {
  ...
  return (
    <div className={`flex flex-col w-[94%] py-[75px] px-12 ${styles.borderColor} ${styles.backgroundColor} border-x items-start justify-start text-6xl font-bold gap-y-4`}>
